...
public class CurriculumVitaeServiceImpl implements CurriculumVitaeService{
    ...
    @Override
    public boolean addCV(CurriculumVitae cv,int id) {
       try {
            Candidate ca = this.candidateRepository.getCandidateByID(id);
            ...
            return this.curriculumVitaeRepository.addCV(cv,id);
